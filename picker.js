var picker = {
	...
	init: function () {
		...
		var s = { h: 217, w: 23, th: id_elements.arrows, bk: id_elements.block, line: id_elements.line };
		/*
...
var Block = {
	...
	init: function (elem) {
		...
		Block.cPos = function (e) {
			...
			if (V < 50) circle.style.borderColor = "#c5c5c5";

			else circle.style.borderColor = "#5B5B5B";
